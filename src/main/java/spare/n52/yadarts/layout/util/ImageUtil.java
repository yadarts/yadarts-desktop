 ...
 */
package spare.n52.yadarts.layout.util;
...
public class ImageUtil {
	 ...
	 * @return scaled image
	 */
	public static org.eclipse.swt.graphics.Image resize(
			org.eclipse.swt.graphics.Image image, float scale) {
		...
		return new org.eclipse.swt.graphics.Image(Display.getDefault(),
				imageData);
	}
	...
	public static Image resizeUsingImageData(Image img, float scale) {
		Rectangle bounds = img.getBounds();
		ImageData data = img.getImageData().scaledTo((int) (bounds.width*scale), (int) (bounds.height*scale));
		return new Image(img.getDevice(), data);
	}
